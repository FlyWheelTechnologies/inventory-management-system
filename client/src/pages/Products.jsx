...
export default function Products() {
  ...
  // ⚡ Bolt Performance Optimization: Memoize expensive filtering and sorting
  // to prevent unnecessary re-computations on unrelated state changes (like pagination/form toggles)
