...
export default function Dashboard() {
  ...
  const chartData = useMemo(() => {
    // ⚡ Bolt: Replaced O(N*M) nested loops with O(N) single-pass hash map aggregation
    // to improve performance during large dataset rendering and prevent UI thread blocking.
