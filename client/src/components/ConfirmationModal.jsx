export default function ConfirmationModal({ show, title, message, onConfirm, onCancel, confirmText = "Confirm", cancelText = "Cancel", type = "danger" }) {
  if (!show) return null;
      ...
      <div className="modal-card" style={{ maxWidth: '380px' }}>
        ...
        <div className="modal-actions" style={{ padding: '0 20px 20px' }}>
          ...
          <button 
            ...
            style={{ background: type === 'danger' ? '#ef4444' : '#2563eb' }}
            onClick={onConfirm}
          >
            {confirmText}
          </button>
